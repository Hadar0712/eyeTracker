...
%	a
% specific PLUX device using the Lab Streaming Layer (LSL) and the device's MAC-address.
%
%	Notes:
...
%addpath(genpath('C:\Users\erezs\OneDrive\Documents\liblsl-Matlab'));
...
inlet = lsl_inlet(streams{1},360,0,1);
